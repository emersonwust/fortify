...
export const getSearchfResultsPage = function (page = state.search.page) {
...
export const updateServings = function (newServings) {
  ...
  state.recipe.ingredients.forEach(ing => {
    ...
    // newQt = oldQt * newServings / oldServings  , e.g. new = 2* 8/4
  });
...
const clearBookmarks = function () {
  // for development to clear the localstorage
